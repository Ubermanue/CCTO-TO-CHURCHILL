...
module.exports.run = async function({ api, event, args, prefix, admin }) {
		...
		const CREATORLINK = "https://www.facebook.com/vixvus";
		const BOTCREATOR = "GURDON X VIXVUS";
		const BOTNAME = "GURDON X VIXVUS ";
		const FILESOWNER = "GURDON X VIXVUS";
...
⁂ Bot Name: GURDON X VIXVYS
✧ Bot Admin: GURDON X VIXVUS 
♛ Bot Admin Link: https://www.facebook.com/vixvus
❂ Bot Prefix: ${prefix}
